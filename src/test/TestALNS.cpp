...
int main(int argc, char *argv[]) {
  ...
  if (argc == 1) {
    ...
    // instancePath = "../data/solomon/r210_21.txt";
    // instancePath = "../data/solomon/r211_21.txt";
    ...
    // instancePath = "../data/solomon/c109_21.txt";
